...
public class ProductTest {
	...
	public void setUp() {
		this.sql2o = new Sql2o(
				"jdbc:mysql://myshop.cvgrlnux4cbv.eu-west-1.rds.amazonaws.com:3306/myshop",
				"myshop-app", "'m:9AU7n");
		try {
	...
	public void fullProductsModelTest() {
		...
		try (Connection con = sql2o.open()) {
			for (Product p : con.createQuery(complexSql)
					.addColumnMapping("product_id", "productID")
					.executeAndFetch(Product.class)) {
				System.out.println(p.getID() + " \t" + p.getName()
						+ " \tCATEGORY: " + p.getCategory() + " LOCATION: "
						+ p.getProductLocation().toString());
			}
		}
	}
